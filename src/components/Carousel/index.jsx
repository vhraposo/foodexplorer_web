...
export function Carousel({ data }) {
    ...
    const dishes = [
        {
          id: 1,  
          image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&q=80&w=1480&ixlib=rb-403.3&ixid=MXwxMjA3fDB8fA%3D',
        ...
        {
          id: 2,  
          image: 'https://media.istockphoto.com/id/1136814342/pt/foto/delicious-spaghetti-served-on-a-black-plate.jpg?s=612x612&w=is&k=20&c=CmBsnnVMo-AJ7ZayaGusePo74lC-qTFIOQK1qTrNsdg=',
    ...
    return(
        <Container className="splide" id={`splide${id}`} aria-labelledby="carousel-heading">
